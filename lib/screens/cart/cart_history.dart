...
class _CartHistoryState extends State<CartHistory> {
  ...
  Widget build(BuildContext context) {
    ...
    var getCartHistoryList=Get.find<CartContrller>().getCartHistoryList().reversed.toList();
    ...
    print("Checkout "+getCartHistoryList.length.toString()+" Items");
                              ...
                              List.generate(itemsPerOrder[i], (index) {
                                ...
                                return index<=2? Container(
                                  ...
                                  decoration: BoxDecoration(
                                      image: DecorationImage(image: NetworkImage(getCartHistoryList[listCounter-1].image),
                                          fit: BoxFit.cover),
                            ...
                            Container(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  GestureDetector(
                                    onTap: () {
                                      print("Doing test "+itemsPerOrder[i].toString());
                                    },
                                    child: Container(
